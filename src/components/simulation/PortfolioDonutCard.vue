...
<template>
  <section class="portfolio-donut-card">
    ...
    <p class="portfolio-rule-note">
      예금과 적금은 금리·납입 한도·운용 기간을 함께 반영해 예상 운용 결과가 더 유리한 쪽에 우선
      배분하므로, 한 가지 상품 유형에만 배분될 수 있어요. 예상 금액은 시뮬레이션 실행 시점의 상품
      데이터로 계산한 참고 금액이며, 실제 수익은 시장 상황과 상품 조건에 따라 달라질 수 있어요.
    </p>
  </section>
</template>
