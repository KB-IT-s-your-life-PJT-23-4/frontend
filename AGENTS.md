...
- When a simulation has no payable tax, do not present tax strategies as a comparison; replace the comparison UI with a single immediate-gift investment outcome.
